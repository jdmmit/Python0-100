...
La cadena de cuerdas con números positivos separados por guiones debe ser ingresada por el usuario. Se supone que la cadena siempre contendrá 3 números entre cada guion y que habrá exactamente 4 tríos de números en la cadena (como se muestra en los ejemplos)."""
...
salida, suma = check_secuencia(secuencia)
